function solve(numberOfPeople, groupType, dayOfTheWeek) {
    ...
    switch(groupType) {
        case 'Students':
            ...
            if ( numberOfPeople >= 30 ) price *= 0.85; // price = price * 0.85;

            break;
            
        case 'Business':

            if ( numberOfPeople >= 100 ) numberOfPeople -= 10; // numberOfPeople = numberOfPeople - 10;
        ...
        case 'Regular':
            ...
            if ( numberOfPeople >= 10 && numberOfPeople <= 20 ) price *= 0.95; // price = price * 0.95;
